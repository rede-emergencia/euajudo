...
class DeliveryStatus(str, Enum):
    """Status for deliveries (volunteer-driven) and services"""
    ...
    IN_TRANSIT = "in_transit"     # On the way to destination
    IN_PROGRESS = "in_progress"   # Service in progress (cleaning, maintenance, etc.)
    DELIVERED = "delivered"       # Successfully delivered (for products)
    COMPLETED = "completed"       # Successfully completed (for services)
    CANCELLED = "cancelled"
    EXPIRED = "expired"
