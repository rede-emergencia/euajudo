...
from app.shared.enums import ProductType, OrderStatus, DeliveryStatus, BatchStatus
...
# ============================================================================
# PRODUCT VALIDATOR MANAGER
# ============================================================================

class ProductValidatorManager:
    """Manager for product validators"""
    
    @staticmethod
    def get_validator(product_type: ProductType) -> ProductValidator:
        """Get validator for specific product type"""
        return ValidatorFactory.get_validator(product_type)
    
    @staticmethod
    def validate_quantity(product_type: ProductType, quantity: int) -> bool:
        """Validate quantity for specific product type"""
        validator = ValidatorFactory.get_validator(product_type)
        return validator.validate_quantity(quantity)
    
    @staticmethod
    def validate_description(product_type: ProductType, description: str) -> bool:
        """Validate description for specific product type"""
        validator = ValidatorFactory.get_validator(product_type)
...
class ProductValidatorManagerCodeValidator(ConfirmationCodeValidator):
    """Combination validator for product validation and code validation"""
    pass
