...
import { Plus, Package, Clock, CheckCircle, X, AlertCircle, Utensils } from 'lucide-react';
...
export default function ShelterDashboard() {
  ...
  const handleCreateRequest = async (e) => {
    ...
    try {
      ...
      showAlert('Sucesso', '✅ Solicitação de marmitas criada com sucesso!', 'success');
  ...
  return (
    <>
      ...
      >
        {loading ? (
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    {activeRequest.quantity} marmitas
                  </div>
                </div>
          ...
          <EmptyState
            ...
            description="Crie uma nova solicitação para começar a receber marmitas de fornecedores."
            action={
              <Button
                onClick={() => setShowRequestForm(true)}
                icon={<Plus size={16} />}
      ...
      <Modal
        ...
        title="Nova Solicitação de Marmitas"
        size="md"
        footer={
          <>
            <Button
        ...
        <form onSubmit={handleCreateRequest} style={{ display: 'flex', flexDirection: 'column', gap: spacing.lg }}>
          ...
          <div style={{
            ...
            <ul style={{
              ...
              <li>Você receberá as marmitas conforme solicitado</li>
            </ul>
          </div>
        </form>
      </Modal>
